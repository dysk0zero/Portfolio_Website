function SoftSkills(){
    const Card = ({ title, content, shadowColor }: { title: string; content: string; shadowColor: string; }) => (
        <div className="flex flex-col text-black py-[20px] pl-[40px] pr-[30px] lg:h-[400px] border-l border-b border-black/40 z-20" style={{ backgroundColor: "#f5f5f5" }} >
            <h3 
    ...
    return (
        <main className="lg:pb-[200px]">
            <div className="absolute max-w-[1200px] px-8 inset-0 mx-auto pointer-events-none">
                ...
                />
                <div
                    className="absolute top-0 w-px bg-black bottom-30 opacity-40"
                    style={{
                    left: `50%`,
                    }}
                />
                <div
                    className="absolute top-[1200px] w-px bg-black bottom-130 z-50 opacity-40"
                    style={{
                    left: `75%`,
                    }}
                />
                <div
                    className="absolute top-0 w-px bg-black bottom-100 opacity-40"
                    style={{
                    left: `100%`,
                    }}
                />
            ...
            <div className="grid grid-cols-2">
                ...
                <div className="relative lg:h-[400px] border-b border-black/40 ">
                    <div 
                        className="absolute bottom-0 w-px bg-black top-40 opacity-40"
                        style={{ left: `50%`}}
                    />
                </div>
                ...
                <div className="absolute bottom-0 w-1/3 border-b left-2/3 border-black/40" />

                {/* Línea vertical */}
                <div 
                    className="absolute top-0 w-px bg-black bottom-40 opacity-40"
                    style={{ left: `50%` }}
                />
                </div>
